        ...
        <Card variant="elevated" className="border border-orange-500/20" style={{ backgroundColor: 'hsl(220 12% 10%)' }}>
          ...
          <CardContent>
            <Button
              ...
              variant="outline"
              size="lg"
              className="w-full mb-4 gap-2 bg-white text-gray-900 hover:bg-gray-100 border-gray-300"
            ...
            <div className="relative mb-4">
              ...
              <div className="relative flex justify-center text-xs uppercase">
                <span className="px-2 text-gray-500" style={{ backgroundColor: 'hsl(220 12% 10%)' }}>ou</span>
              </div>
            </div>
